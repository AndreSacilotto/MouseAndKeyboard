...
public record class KeyboardEventData(VirtualKey KeyCode, ScanCode ScanCode, bool IsKeyDown, bool IsKeyUp, bool Control, bool Shift, bool Alt, bool IsExtendedKey, int Timestamp) : EventData(Timestamp)
{
}