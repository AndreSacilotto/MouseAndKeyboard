...
public enum MapType : uint
{
    ...
    /// <br/>If it is a virtual-key code that does not distinguish between left- and right-hand VirtualKey, the left-hand scan code is returned. 
    /// <br/>If there is no translation, the function returns 0.
    /// </summary>
    VK_TO_VSC = 0,
    /// <summary>
    /// ScanCode to VirtualKey
    /// <br/>The uCode parameter is a scan code and is translated into a virtual-key code that does not distinguish between left- and right-hand VirtualKey. 
    /// <br/>If there is no translation, the function returns 0.
    /// </summary>
    VSC_TO_VK = 1,
    /// <summary>
    ...
    /// <br/>Dead VirtualKey (diacritics) are indicated by setting the top bit of the return Value. 
    /// <br/>If there is no translation, the function returns 0. See Remarks.
    /// </summary>
    VK_TO_CHAR = 2,
    /// <summary>
    /// ScanCode to VirtualKey with L and R
    /// <br/>The uCode parameter is a scan code and is translated into a virtual-key code that distinguishes between left- and right-hand VirtualKey. 
    /// <br/>If there is no translation, the function returns 0.
    /// </summary>
    VSC_TO_VK_EX = 3,
    /// <summary>
