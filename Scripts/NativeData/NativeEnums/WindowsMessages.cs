...
public enum WindowsMessages : uint
{
    ...
    /// <summary>
    /// The WM_QUEUESYNC message is sent by a computer-based training (CBT) application to separate user-input messages from other messages sent through the WH_JOURNALPLAYBACK CreateHook procedure.
    /// </summary>
    QUEUESYNC = 0x0023,
    /// <summary>
